...
class RegisterProviderController extends ChangeNotifier {
  ...
  Future<MessageType> onRegisterApiCalling({
    ...
    try {
      ...
      MessageType messageType =
          await AuthApiService.authApiService.registrationApiCalling(
        firstname: firstname,
        lastname: lastname,
        email: email,
        password: password,
